...
- هماهنگ‌سازی فیلتر زمان درخواست‌های خرید با طراحی و انتخاب «همه زمان‌ها» به‌عنوان مقدار پیش‌فرض فرانت‌اند و API.
- اصلاح صفحه موفقیت و باکس مراحل فلو فروش مطابق آخرین طراحی V2.
- رفع نمایش شکسته پیش‌نمایش تصویر در اولین آپلود و حفظ تصویر هنگام رفت‌وبرگشت بین مراحل.
- بهبود تعامل‌های جدول محصولات، جزئیات درخواست و رابط عمومی Market.
- افزودن تست Chrome برای وضعیت‌های مراحل، پیش‌نمایش تصویر و شواهد جدید Visual QA.
...
[2.0.1]: https://github.com/erfanshafieeee/Carpet-Market/releases/tag/v2.0.1
